# Contributing to nx-plugins

We would love for you to contribute to nx-plugins and help make it even better than it is
...
Help us keep nx-plugins open and inclusive. Please read and follow our [Code of Conduct](CODE_OF_CONDUCT.md).

## <a name="question"></a> Got a Question or Problem?
If you have any questions regarding how to use nx-plugins or contributing to this repo
...
You can file new issues by filling out our [new issue form](https://github.com/loft-orbital/nx-plugins/issues/new/choose) using the **Bug report** template.
...
1. Fork the loft-orbital/nx-plugins repo.
...
1. In GitHub, send a pull request to `cuebe:main`.
